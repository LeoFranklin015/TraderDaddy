 ...
 */
function generateEmbeddingsPrompt(asset: any, marketData: any, sentiment: any) {
...
- Trend: ${marketData.trendMetrics.direction} (Strength: ${
    marketData.trendMetrics.strength
  })
...
export async function generateEmbeddings(
  ...
  const file_ids = [
    "40f0b3c7-8b2d-4071-a066-a92cfa13ee05",
    "4d164884-4eb4-4f44-a4f8-755270d4736e",
    "6d3c84e9-3c16-4487-95e8-a3941a956bf8",
    "fa2e52c2-cb56-4491-b0b0-bde9e0a9607d",
    "94c868e2-262e-45ab-be23-47be5028361d",
    "284c006d-fbba-43df-8ef7-4c2bbfa856af",
  ];
  ...
  const { success, documents }: any = await response.json();
  if (success) {
    documents.forEach(({ content, file_id, score }: any, index: any) => {
      console.log(file_id);
